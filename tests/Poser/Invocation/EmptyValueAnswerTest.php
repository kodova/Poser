...
class EmptyValueAnswerTest extends PHPUnit_Framework_TestCase {
	...
	public function testAnswerWithStringType(){
		$method = 'stringMethod';
		$invocation = new Invocation(new \Helpers\Test\ReturnTypeClass(), $method, array(), new SplDoublyLinkedList());
	...
	public function testAnswerWithNullMethod(){
		...
		$invocation = new Invocation($mock, 'something', array(), new SplDoublyLinkedList());
		$return = $this->underTest->answer($invocation);
		$this->assertNull($return);
	}
}